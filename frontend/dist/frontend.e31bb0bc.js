...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"pacman-setup.js":[function(require,module,exports) {
"use strict";
...
exports.LEVEL = LEVEL;
},{}],"ghost-moves.js":[function(require,module,exports) {
"use strict";
...
var _pacmanSetup = require("./pacman-setup");
...
function randomMovement(position, direction, objectExist) {
  ...
  var keys = Object.keys(_pacmanSetup.DIRECTIONS);

  while (objectExist(nextMovePos, _pacmanSetup.OBJECT_TYPE.WALL) || objectExist(nextMovePos, _pacmanSetup.OBJECT_TYPE.GHOST)) {
    // Get a random key from that array
    var key = keys[Math.floor(Math.random() * keys.length)]; // Set the new direction

    dir = _pacmanSetup.DIRECTIONS[key]; // Set the next move
...
},{"./pacman-setup":"pacman-setup.js"}],"node_modules/@babel/runtime/helpers/arrayLikeToArray.js":[function(require,module,exports) {
...
},{}],"game-board.js":[function(require,module,exports) {
"use strict";
...
var GameBoard = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GameBoard, [{
    ...
    value: function createGrid(level) {
      ...
      this.DOMGrid.style.cssText = "grid-template-columns: repeat(".concat(_pacmanSetup.GRID_SIZE, ", ").concat(_pacmanSetup.CELL_SIZE, "px);");
      level.forEach(function (square) {
        var div = document.createElement('div');
        div.classList.add('square', _pacmanSetup.CLASS_LIST[square]);
        div.style.cssText = "width: ".concat(_pacmanSetup.CELL_SIZE, "px; height: ").concat(_pacmanSetup.CELL_SIZE, "px;");
        ...
        if (_pacmanSetup.CLASS_LIST[square] === _pacmanSetup.OBJECT_TYPE.DOT) _this.dotCount++;
      });
    }
  }, {
    key: "addObject",
...
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./pacman-setup":"pacman-setup.js"}],"node_modules/@babel/runtime/helpers/defineProperty.js":[function(require,module,exports) {
...
var Pacman = /*#__PURE__*/function () {
  function Pacman(speed, startPos) {
    ...
    (0, _defineProperty2.default)(this, "handleKeyInput", function (e, objectExist) {
      ...
      if (e.keyCode >= 37 && e.keyCode <= 40) {
        dir = _pacmanSetup.DIRECTIONS[e.key];
      } else {
        return;
      }

      var nextMovePos = _this.pos + dir.movement;
      if (objectExist(nextMovePos, _pacmanSetup.OBJECT_TYPE.WALL)) return;
      _this.dir = dir;
    });
    this.pos = startPos;
    this.speed = speed;
  ...
  (0, _createClass2.default)(Pacman, [{
    ...
    value: function getNextMove(objectExist) {
      ...
      if (objectExist(nextMovePos, _pacmanSetup.OBJECT_TYPE.WALL) || objectExist(nextMovePos, _pacmanSetup.OBJECT_TYPE.GHOSTLAIR)) {
    ...
    value: function makeMove() {
      var classesToRemove = [_pacmanSetup.OBJECT_TYPE.PACMAN];
      var classesToAdd = [_pacmanSetup.OBJECT_TYPE.PACMAN];
      return {
...
var _default = Pacman;
exports.default = _default;
},{"@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/helpers/defineProperty":"node_modules/@babel/runtime/helpers/defineProperty.js","./pacman-setup":"pacman-setup.js"}],"ghost.js":[function(require,module,exports) {
"use strict";
...
var _ghostMoves = require("./ghost-moves");
...
var Ghost = /*#__PURE__*/function () {
  function Ghost() {
    ...
    this.pos = startPos;
    this.dir = _pacmanSetup.DIRECTIONS.ArrowRight;
    this.speed = speed;
    this.timer = 0;
    this.isScared = false;
    this.rotation = false;
  ...
  (0, _createClass2.default)(Ghost, [{
    ...
    key: "makeMove",
    value: function makeMove() {
      var classesToRemove = [_pacmanSetup.OBJECT_TYPE.GHOST, _pacmanSetup.OBJECT_TYPE.SCARED, this.name];
      var classesToAdd = [_pacmanSetup.OBJECT_TYPE.GHOST, this.name];
      if (this.isScared) classesToAdd = [].concat((0, _toConsumableArray2.default)(classesToAdd), [_pacmanSetup.OBJECT_TYPE.SCARED]);
      return {
        classesToRemove: classesToRemove,
        classesToAdd: classesToAdd
      };
...
var _default = Ghost;
exports.default = _default;
},{"@babel/runtime/helpers/toConsumableArray":"node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/classCallCheck":"node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"node_modules/@babel/runtime/helpers/createClass.js","./pacman-setup":"pacman-setup.js","./ghost-moves":"ghost-moves.js"}],"node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"node_modules/process/browser.js"}],"sounds/munch.wav":[function(require,module,exports) {
...
var scoreTable = document.querySelector('#score'); // Game constants

var POWER_PILL_TIME = 10000; // ms

var GLOBAL_SPEED = 80; // ms

var gameBoard = _gameBoard.default.createGameBoard(gameGrid, _pacmanSetup.LEVEL); // Initial setup


var status = "highscore";
var score = 0;
var timer = null;
var gameWin = false;
...
function gameOver() {
  ...
  (0, _jquery.default)('#gameOverScreen').addClass('is-active');
  (0, _jquery.default)("#gameOverTitle").html(gameWin ? "You won!!!!" : "Game OVer");
  (0, _jquery.default)("#gameOverScore").html(score);
  ...
  _jquery.default.ajax({
    ...
    complete: function complete() {
      _jquery.default.ajax({
        ...
        (0, _jquery.default)("#gameOverBestScore").html(score);
        (0, _jquery.default)("#gameOverBestDate").html(data.formattedDateTime);
      });
    }
  });
}
...
function checkCollision() {
  ...
  if (collidedGhost) {
    if (pacman.powerPill) {
      ...
      gameBoard.removeObject(collidedGhost.pos, [_pacmanSetup.OBJECT_TYPE.GHOST, _pacmanSetup.OBJECT_TYPE.SCARED, collidedGhost.name]);
      collidedGhost.pos = collidedGhost.startPos;
      score += 100;
    } else {
      gameBoard.removeObject(pacman.pos, [_pacmanSetup.OBJECT_TYPE.PACMAN]);
...
function gameLoop() {
  ...
  checkCollision(); // 3. Move ghosts

  ghosts.forEach(function (ghost) {
    return gameBoard.moveCharacter(ghost);
  }); // 4. Do a new ghost collision check on the new positions

  checkCollision(); // 5. Check if Pacman eats a dot

  if (gameBoard.objectExist(pacman.pos, _pacmanSetup.OBJECT_TYPE.DOT)) {
    playAudio(_munch.default);
    gameBoard.removeObject(pacman.pos, [_pacmanSetup.OBJECT_TYPE.DOT]); // Remove a dot
  ...
  if (gameBoard.objectExist(pacman.pos, _pacmanSetup.OBJECT_TYPE.PILL)) {
    playAudio(_pill.default);
    gameBoard.removeObject(pacman.pos, [_pacmanSetup.OBJECT_TYPE.PILL]);
...
function startGame() {
  (0, _jquery.default)('#userNameScreen').removeClass('is-active');
  playAudio(_game_start.default);
  gameWin = false;
  powerPillActive = false;
  score = 0;
  status = "running";
  pacman = new _pacman.default(2, 287);
  gameBoard.createGrid(_pacmanSetup.LEVEL);
  gameBoard.addObject(287, [_pacmanSetup.OBJECT_TYPE.PACMAN]);
  document.addEventListener('keydown', function (e) {
    return pacman.handleKeyInput(e, gameBoard.objectExist.bind(gameBoard));
  });
  ghosts = [new _ghost.default(5, 188, _ghostMoves.randomMovement, _pacmanSetup.OBJECT_TYPE.BLINKY), new _ghost.default(10, 209, _ghostMoves.randomMovement, _pacmanSetup.OBJECT_TYPE.PINKY), new _ghost.default(3, 230, _ghostMoves.randomMovement, _pacmanSetup.OBJECT_TYPE.INKY), new _ghost.default(2, 251, _ghostMoves.randomMovement, _pacmanSetup.OBJECT_TYPE.CLYDE)]; // Gameloop
...
function highscore() {
  status = 'highscore';
  (0, _jquery.default)('#startScreen').addClass('is-active');
  (0, _jquery.default)('#gameOverScreen').removeClass('is-active');

  _jquery.default.ajax({
    url: "http://localhost:8080/highscore"
  }).then(function (data) {
    if (data.length == 0) {
      (0, _jquery.default)('#highscoreValues').html("<p class=\"has-text-centered mt-6 mb-6 is-size-4\" style=\"color: darkslateblue; font-family: 'Joystix'\">no highscore available</p>");
    } else {
      var highscoreColumns = "";

      for (var i = 0; i < data.length; i++) {
        highscoreColumns += "<div class=\"columns\">\n        <div class=\"column is-4\" style=\"color: darkslateblue; font-family: 'Joystix'\">\n        ".concat(i + 1, ".&nbsp;").concat(data[i].user, "\n        </div>\n        <div class=\"column is-2\" style=\"color: darkslateblue; font-family: 'Joystix'\">\n          ").concat(('000' + data[i].score).slice(-5), "\n        </div>\n        <div class=\"column is-6 has-text-right\" style=\"color: darkslateblue; font-family: 'Joystix'\">\n          ").concat(data[i].formattedDateTime, "\n        </div>\n      </div>");
      }

      (0, _jquery.default)('#highscoreValues').html(highscoreColumns);
    }
  });
}
...
function pauseGame() {
  status = 'paused';
  (0, _jquery.default)('#pauseScreen').addClass('is-active');
  document.removeEventListener('keydown', function (e) {
    return pacman.handleKeyInput(e, gameBoard.objectExist.bind(gameBoard));
  });
  clearInterval(timer);
...
function resumeGame() {
  status = 'running';
  (0, _jquery.default)('#pauseScreen').removeClass('is-active');
  document.addEventListener('keydown', function (e) {
    return pacman.handleKeyInput(e, gameBoard.objectExist.bind(gameBoard));
  });
  timer = setInterval(function () {
